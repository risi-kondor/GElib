...
namespace GElib{
...
#ifdef _WITH_CUDA
  void SO3part_addCGproduct_back0_cu(const cnine::Ctensor3_view& xg, cnine::Ctensor3_view rg, const cnine::Ctensor3_view& y, 
  ...
  public:
	...
	SO3part_addCGproduct_back0_cu(_xg,_g,_y,_offs,stream);
