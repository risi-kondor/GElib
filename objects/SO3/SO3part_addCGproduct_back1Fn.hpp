...
namespace GElib{
...
#ifdef _WITH_CUDA
  void SO3part_addCGproduct_back1_cu(const cnine::Ctensor3_view& yg, cnine::Ctensor3_view g, const cnine::Ctensor3_view& x, 
  ...
  public:
	...
	SO3part_addCGproduct_back1_cu(_yg,_g,_x,_offs,stream);
