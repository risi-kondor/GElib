...
namespace GElib{
  ...
  void SO3partB_addBlockedCGproduct_back0_cu(const cnine::Ctensor3_view& xg, cnine::Ctensor3_view rg, const cnine::Ctensor3_view& y, 
  ...
  public:
	...
	CUDA_STREAM(SO3partB_addBlockedCGproduct_back0_cu(_xg,_g,_y,bsize,_offs,stream));
      }
