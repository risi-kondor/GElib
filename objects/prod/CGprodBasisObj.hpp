...
namespace GElib{
  ...
  public: // ---- Index maps ---------------------------------------------------------------------------------
    ...
    int left_triple_index(const _IrrepIx l1, const _IrrepIx l2, const _IrrepIx l3, const _IrrepIx l12, const _IrrepIx l){
      return left_triple_index_map()(l1,l2,l3,l12,l);
    }

    int right_triple_index(const _IrrepIx l1, const _IrrepIx l2, const _IrrepIx l3, const _IrrepIx l23, const _IrrepIx l){
      return right_triple_index_map()(l1,l2,l3,l23,l);
    }
    ...
    cnine::cachedf<TripleIndexMap> right_triple_index_map=
      cnine::cachedf<TripleIndexMap>([&](){
	  auto R=new TripleIndexMap();
