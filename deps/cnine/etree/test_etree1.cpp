...
int main(int argc, char** argv){
  ...
  ptree prg;
  auto A=prg.add_input(new tensor_node(0,{0,1}));
  auto B=prg.add_input(new tensor_node(1,{1,2}));
  auto C=prg.add_input(new tensor_node(2,{2,3}));
  auto R=prg.add_output(new tensor_node(4,{0,3}));
