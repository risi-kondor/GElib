...
py::class_<SO3mweights>(m,"SO3mweights",
  "Vector of multi-channel weight matrices")

  .def_static("raw",[](const int k, const vector<int>& tau1, const vector<int>& tau2, const int dev){
      return SO3mweights::raw(k,tau1,tau2,dev);},py::arg("k"),py::arg("tau1"),py::arg("tau2"),py::arg("device")=0)
